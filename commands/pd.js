module.exports = {
	...
	execute(message, args) {
		...
		let sentences90  = ["How was the ribs removal surgery ? I hope you're okay !", "I didn't know James Charles had another brother ( ͠° ͟ʖ ͡°)", "Honey could be a good medicine for your sore throat"];
		...
		const pdEmbed = new Discord.MessageEmbed()
			...
			.setTitle("how deps are you ? let's find out")
			.setDescription(txt);

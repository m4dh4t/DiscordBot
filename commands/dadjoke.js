module.exports = {
	...
	execute(message, args) {
		...
		const tLinks = ['https://i.chzbgr.com/full/9530114816/h6FC9B3EC/suit-rip-big-fart-and-say-does-someone-smell-popcorn-and-they-take-big-sniff',
		...
		const random = Math.floor(Math.random() * tLinks.length); //Nombre de "=" -> entre 0 et [nombre-1]
